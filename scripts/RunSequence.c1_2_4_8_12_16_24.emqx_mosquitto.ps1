...
Start-Process -FilePath ".\EntityFX.MqttBenchmark.Bomber.exe" -Wait -ArgumentList "-c appsettings.c1_2_4_8_12_16_24.emqx_mosquitto.json ScenarioNameTemplates:benchmark-qos{qos}-{servers-host}-{clients}cl:MessageSize=16"
...
Start-Process -FilePath ".\EntityFX.MqttBenchmark.exe" -Wait -ArgumentList "-c appsettings.c1_2_4_8_12_16_24.emqx_mosquitto.json Tests:InParallel=false Tests:Settings:MessageSize=16 Tests:Settings:TestMaxTime=00:00:30"
